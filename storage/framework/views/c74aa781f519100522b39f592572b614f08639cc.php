                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <a href="<?php echo e(route('dashboard.donation.barang.create')); ?>" class="btn btn-primary">Buat Donasi</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="datatables-reponsive" class="table table-striped" style="width:100%">
                                ...
                                <?php $__currentLoopData = $donations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img width="75" height="75" src="<?php echo e(asset('storage/'.$donation->photo)); ?>" alt="">
                                        </td>
                                        <td>
                                            <td>
                                                <div>
                                                <a class="btn btn-info" href="<?php echo e(route('dashboard.donation.barang.edit',$donation->order_id)); ?>"><i class="align-middle" data-feather="edit-2"></i></a>
                                                <a class="btn btn-danger delete" data-id="<?php echo e($donation->order_id); ?>"><i class="align-middle" data-feather="trash"></i></a>
                                                </div>
                                            </td>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hewlett Packard\OneDrive\Documents\GitHub\panti-asuhan\panti-asuhan\resources\views/dashboard/pages/donation/barang.blade.php ENDPATH**/ ?>