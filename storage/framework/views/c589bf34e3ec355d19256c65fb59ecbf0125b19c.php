    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <?php endif; ?>
                <li class="nav-item <?php echo e(request()->is('blog') ? 'active' : ''); ?>"><a href="/blog" class="nav-link">Blog</a></li>
...
<?php /**PATH C:\laragon\www\panti-asuhan\resources\views/layouts/header.blade.php ENDPATH**/ ?>