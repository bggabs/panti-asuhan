                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <a target="_blank" href="<?php echo e(route('dashboard.donation.barang.create')); ?>" class="btn btn-primary">Buat Donasi</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\panti-asuhan\resources\views/dashboard/pages/donation/barang.blade.php ENDPATH**/ ?>