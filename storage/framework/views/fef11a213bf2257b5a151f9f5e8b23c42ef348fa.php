                                            ...
                                            <div class="row">
                                                <div class="mb-3">
                                                    <div class="mb-3 col-md-8">
                                                        ...
                                                        <textarea name="description" id="" value="<?php echo e(old('description')); ?>" class="form-control" cols="30" rows="10"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
...
<?php echo $__env->make('dashboard.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\panti-asuhan\resources\views/dashboard/pages/donation/create.blade.php ENDPATH**/ ?>