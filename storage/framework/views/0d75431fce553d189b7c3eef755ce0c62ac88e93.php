            ...
            <div class="row block-9">
                <div class="col-md-6 pr-md-5">
                    ...
                    <form id="donate-form" method="POST" action="#">
                        <input type="hidden" name="activity_id" value="<?php echo e($event->id); ?>">
                ...
                <div class="col-md-6">
                    <div class="blog-entry align-self-stretch" style="box-shadow: none!important;">
                        <a class="block-20" style="background-image: url('<?php echo e(asset('storage/'.$event->photo)); ?>');">
                        </a>
                        <div class="text p-4 d-block">
                            <div class="meta mb-3">
                                <div><a href="#">Created by Admin</a></div>
                            </div>
                            <h3 class="heading mb-4"><a href="#"><?php echo e($event->name); ?></a></h3>
                            <p class="time-loc"><span class="mr-2"><i class="icon-clock-o"></i> <?php echo e($event->datetime); ?></span> <span><i class="icon-map-o"></i> <?php echo e($event->location); ?></span></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\panti-asuhan\resources\views/donateform-event.blade.php ENDPATH**/ ?>