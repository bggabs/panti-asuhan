...
@section('content')
    ...
    <div class="hero-wrap" style="background-image: url({{asset('images/foto1.jpg')}});" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section-3 img" style="background-image: url({{asset('images/bg_3.jpg')}});" id="donatur">
        <div class="overlay"></div>
        <div class="container">
            <div class="row d-md-flex">
                ...
                <div class="col-md-6 volunteer pl-md-5 ftco-animate">
                    ...
                    <form action="{{ route('register') }}" method="post" class="volunter-form">
                        @csrf
