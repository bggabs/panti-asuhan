                            ...
                            <table id="datatables-reponsive" class="table table-striped" style="width:100%">
                                ...
                                @foreach($donations as $donation)
                                    <tr>
                                        ...
                                        <td>
                                            <img width="75" height="75" src="{{asset('storage/'.$donation->photo)}}" alt="">
                                        </td>
                                        <td>
                                            <td>
                                                <div>
                                                <a class="btn btn-info" href="{{ route('dashboard.donation.barang.edit',$donation->order_id) }}"><i class="align-middle" data-feather="edit-2"></i></a>
                                                <a class="btn btn-danger delete" data-id="{{$donation->order_id}}"><i class="align-middle" data-feather="trash"></i></a>
                                                </div>
                                            </td>
                                        </td>
                                    </tr>
