                                        ...
                                        <form action="{{Route('dashboard.donation.barang.store')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-8">
                                                    ...
                                                    <input type="name" class="form-control" value="{{old('name')}}" name="name" id="inputEmail4" placeholder="Nama Barang">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="mb-3">
                                                    <div class="mb-3 col-md-8">
                                                        ...
                                                        <input type="number" class="form-control" value="{{old('amount')}}" name="amount" id="inputAddress2" placeholder="Jumlah Barang">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="mb-3">
                                                    <div class="mb-3 col-md-8">
                                                        ...
                                                        <textarea name="description" id="" value="{{old('description')}}" class="form-control" cols="30" rows="10"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
