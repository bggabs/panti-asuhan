            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a type="button" href="{{ route('dashboard.galeries.create') }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($galeries as $gallery)
                                        <tr>
                                            ...
                                            {{--                                            </a></td> --}}
                                            <td>
                                                <a href="{{ asset('storage/' . $gallery->photo) }}" data-lightbox="image-1"
                                                    data-title="My caption"><img
                                                        src="{{ asset('storage/' . $gallery->photo) }}" class="img-fluid"
                                            ...
                                            <td>
                                                <div>
                                                    <a class="btn btn-info"
                                                        href="{{ route('dashboard.galeries.edit', $gallery->id) }}"><i
                                                            class="align-middle" data-feather="edit-2"></i></a>
                                                    <a data-id="{{ $gallery->id }}" class="btn btn-danger delete"><i
